        ...
        <li class="vcard">
            <span class="fn n">
                <a class="url" href="http://univis.uni-erlangen.de/prg?search=persons&id=<?php echo $person->id;?>&show=info">
                    ...
                    <?php endif; ?>
                    <span class="given-name"><?php echo $person->firstname;?></span>
                    <span class="family-name"><?php echo $person->lastname;?><?php if (!empty($person->atitle)) : ?>, <?php endif; ?></span>
                    <?php if (!empty($person->atitle)) : ?>
                    <span class="honorific-suffix">
                        <acronym title=""><?php echo $person->atitle;?></acronym>
                    </span>
                    <?php endif; ?>
                </a>
            </span>
