    ...
    public function __construct() {
        $this->config = [
            ...
            'constants' => [
                ...
                'langcodes' => [
                    'de' => __('German', 'rrze-univis'),
                    'en' => __('English', 'rrze-univis'),
                    'es' => __('Spanish', 'rrze-univis'),
                    'fr' => __('French', 'rrze-univis'),
                    'ru' => __('Russian', 'rrze-univis'),
                    'zh' => __('Chinese', 'rrze-univis'),
                ],
                'endpoints' => [
                    'person' => 'univisid',
                    'lecture' => 'lv_id',
            ...
            'shortcode_settings' => [
                'mitarbeiter' => [
                    'block' => [
                        ...
                        'description' => __('Display UnivIS employees and organizational staff listings.', 'rrze-univis'),
                        'keywords' => ['univis', 'mitarbeiter', 'personen', 'person', 'fau'],
                        'category' => 'fau',
                        'icon' => 'admin-users',
                        'tinymce_icon' => 'user',
                    ],
                ...
                'lehrveranstaltungen' => [
                    'block' => [
                        ...
                        'description' => __('Display UnivIS lectures and lecture listings.', 'rrze-univis'),
                        'keywords' => ['univis', 'lehrveranstaltungen', 'vorlesung', 'lecture', 'fau'],
                        'category' => 'fau',
                        'icon' => 'bank',
                        'tinymce_icon' => 'paste',
                    ],
                ...
                'publikationen' => [
                    'block' => [
                        ...
                        'description' => __('Display UnivIS publications.', 'rrze-univis'),
                        'keywords' => ['univis', 'publikationen', 'publication', 'publikationen', 'fau'],
                        'category' => 'fau',
                        'icon' => 'megaphone',
    ...
    public function getFields(): array {
        return [
            'basic' => [
                ...
                ['name' => 'public_visiblity_required_hosts', 'label' => __('Required hosts for nonpublic data', 'rrze-univis'), 'desc' => __('Nonpublic persons\'s data will be displayed only on hosts from the given hostnames', 'rrze-univis'), 'type' => 'textarea', 'default' => $this->get('constants.defaults.public_visibility_required_hosts')],
                ['name' => 'semesterMin', 'label' => __('Find lectures from the summer semester', 'rrze-univis'), 'desc' => __('', 'rrze-univis'), 'placeholder' => '', 'min' => 0, 'max' => 99999999999, 'step' => '1', 'type' => 'number', 'default' => date('Y') - 1, 'sanitize_callback' => 'floatval'],
                ['name' => 'wsStart', 'label' => __('Lectures begin this winter semester', 'rrze-univis'), 'desc' => __('', 'rrze-univis'), 'placeholder' => '', 'type' => 'date', 'default' => date('Y') - 1 . '-11-02', 'sanitize_callback' => 'sanitize_text_field'],
                ['name' => 'wsEnd', 'label' => __('End of the lecture period this winter semester', 'rrze-univis'), 'desc' => __('', 'rrze-univis'), 'placeholder' => '', 'type' => 'date', 'default' => date('Y') . '-02-12', 'sanitize_callback' => 'sanitize_text_field'],
                ['name' => 'ssStart', 'label' => __('Lectures begin this summer semester', 'rrze-univis'), 'desc' => __('', 'rrze-univis'), 'placeholder' => '', 'type' => 'date', 'default' => date('Y') . '-04-12', 'sanitize_callback' => 'sanitize_text_field'],
                ['name' => 'ssEnd', 'label' => __('End of the lecture period this summer semester', 'rrze-univis'), 'desc' => __('', 'rrze-univis'), 'placeholder' => '', 'type' => 'date', 'default' => date('Y') . '-07-16', 'sanitize_callback' => 'sanitize_text_field'],
